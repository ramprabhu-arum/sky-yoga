...
// ─── PROGRAMS (multi-day courses with fees) ───
const PROGRAMS_INIT = [
  { id: "p1", centerId: "c1", title: "5-Day SKY Meditation Intensive", practiceType: "meditation", audience: "adults", format: "5 consecutive days", schedule: "Mon–Fri, Mar 10–14, 2026 · 6:30 – 8:00 PM", startDate: "2026-03-10", endDate: "2026-03-14", fee: 150, currency: "USD", capacity: 30, registered: 12, instructor: "Dr. Lakshmi Narayanan", description: "A comprehensive introduction to SKY Meditation covering Levels 1 and 2. Learn powerful meditation techniques on the life force, simplified physical exercises, and introspection basics. Certificate awarded upon completion.", whatToBring: "Comfortable clothing, yoga mat (or we can provide one), water bottle", paymentInstructions: "Zelle to skyyogaplano@gmail.com — Reference: your name + PLN-SKY-MAR", slug: "plano-5day-meditation-mar2026" },
  { id: "p2", centerId: "c1", title: "Kids Yoga & Meditation Camp", practiceType: "meditation", audience: "kids", format: "Saturday mornings, 4 weeks", schedule: "Saturdays, Mar 1–22, 2026 · 10:00 – 11:30 AM", startDate: "2026-03-01", endDate: "2026-03-22", fee: 60, currency: "USD", capacity: 20, registered: 8, instructor: "Prof. Divya", description: "Fun and engaging yoga program designed for children ages 6–12. Includes breathing exercises, simple meditation, storytelling, and group activities to build focus and confidence.", whatToBring: "Comfortable clothes, water bottle, small snack", paymentInstructions: "Zelle to skyyogaplano@gmail.com — Reference: child's name + PLN-KIDS-MAR", slug: "plano-kids-camp-mar2026" },
  { id: "p3", centerId: "c2", title: "Teen Mindfulness Workshop", practiceType: "introspection", audience: "teens", format: "Weekend workshop", schedule: "Sat–Sun, Mar 8–9, 2026 · 9:00 AM – 1:00 PM", startDate: "2026-03-08", endDate: "2026-03-09", fee: 40, currency: "USD", capacity: 25, registered: 6, instructor: "Prof. Arun", description: "Two-day workshop for teens (13–17) covering meditation basics, emotional regulation through introspection, and practical tools for managing stress and academic pressure.", whatToBring: "Journal/notebook, comfortable clothing", paymentInstructions: "Zelle to skydallas@gmail.com — Reference: teen's name + DAL-TEEN-MAR", slug: "dallas-teen-mindfulness-mar2026" },
  { id: "p4", centerId: "c3", title: "Kayakalpa Yoga Beginners Course", practiceType: "kayakalpa", audience: "adults", format: "3 consecutive days", schedule: "Fri–Sun, Mar 21–23, 2026 · 6:00 – 8:00 PM", startDate: "2026-03-21", endDate: "2026-03-23", fee: 100, currency: "USD", capacity: 20, registered: 14, instructor: "Prof. Sundar", description: "Learn the ancient Siddha science of Kayakalpa Yoga for body rejuvenation and life energy enhancement. Includes theory, practice, and dietary guidance. Prerequisite: None.", whatToBring: "Comfortable clothing, notebook", paymentInstructions: "Zelle to skyfrisco@gmail.com — Reference: your name + FRS-KKY-MAR", slug: "frisco-kayakalpa-mar2026" },
  { id: "p5", centerId: "c20", title: "Online SKY Meditation Level 1", practiceType: "meditation", audience: "adults", format: "5 evenings over 2 weeks", schedule: "Mon & Wed, Mar 3–17, 2026 · 7:30 – 9:00 PM CST", startDate: "2026-03-03", endDate: "2026-03-17", fee: 100, currency: "USD", capacity: 50, registered: 22, instructor: "Dr. Lakshmi Narayanan", description: "Full SKY Meditation Level 1 course delivered online via Zoom. Same curriculum as in-person programs. Interactive sessions with live instruction and Q&A. Zoom link sent after registration.", whatToBring: "Quiet space, stable internet, yoga mat", paymentInstructions: "Zelle to skyyogaonline@gmail.com — Reference: your name + ONL-SKY-MAR", slug: "online-meditation-level1-mar2026" },
  { id: "p6", centerId: "c9", title: "Family Yoga Weekend", practiceType: "exercise", audience: "family", format: "Single weekend", schedule: "Sat, Mar 15, 2026 · 9:00 AM – 12:00 PM", startDate: "2026-03-15", endDate: "2026-03-15", fee: 0, currency: "USD", capacity: 40, registered: 18, instructor: "Prof. Venkat", description: "A free family-friendly yoga event! Parents and children practice together — simplified physical exercises, breathing techniques, and a short group meditation. All ages welcome.", whatToBring: "Yoga mats for each family member, water bottles", paymentInstructions: "", slug: "chicago-family-yoga-mar2026" },
  { id: "p7", centerId: "c17", title: "Introspection Level I Course", practiceType: "introspection", audience: "adults", format: "2 full days", schedule: "Sat–Sun, Apr 5–6, 2026 · 9:00 AM – 5:00 PM", startDate: "2026-04-05", endDate: "2026-04-06", fee: 120, currency: "CAD", capacity: 25, registered: 9, instructor: "Prof. Meena", description: "Deep dive into self-inquiry and emotional transformation. Learn to identify and sublimate negative mental patterns through systematic introspection. Lunch provided.", whatToBring: "Journal, comfortable clothing, open mind", paymentInstructions: "Interac e-Transfer to skytoronto@gmail.com — Reference: your name + TOR-INT-APR", slug: "toronto-introspection-apr2026" },
  { id: "p8", centerId: "c13", title: "8-Week Meditation Journey", practiceType: "meditation", audience: "adults", format: "Weekly, 8 weeks", schedule: "Every Thursday, Mar 6 – Apr 24, 2026 · 7:00 – 8:30 PM", startDate: "2026-03-06", endDate: "2026-04-24", fee: 200, currency: "USD", capacity: 25, registered: 16, instructor: "Prof. Ramesh", description: "A progressive 8-week meditation program covering SKY Meditation Levels 1 through 3. Each week builds on the previous, with take-home practice assignments. Ideal for committed practitioners.", whatToBring: "Comfortable clothing, yoga mat, journal", paymentInstructions: "Zelle to skysanjose@gmail.com — Reference: your name + SJ-8WK-MAR. Partial payments accepted: $100 at registration, $100 by week 4.", slug: "sanjose-8week-meditation-mar2026" },
];
...
function ProgramRegModal({ program, onClose, members, onRegister }) {
  const [step, setStep] = useState(1);
  const [emailChecked, setEmailChecked] = useState(false);
  const [existingMember, setExistingMember] = useState(null);
  const [form, setForm] = useState({ name: "", email: "", phone: "", ageGroup: "", emergencyContact: "", emergencyPhone: "", notes: "" });
  const center = CENTERS.find(c => c.id === program.centerId);
  const practice = PRACTICES.find(p => p.id === program.practiceType);
  const spotsLeft = program.capacity - program.registered;

  const checkEmail = () => {
    if (!form.email) return;
    const found = members.find(m => m.email.toLowerCase() === form.email.toLowerCase());
    if (found) {
      setExistingMember(found);
      setForm(f => ({ ...f, name: found.name, phone: found.phone || f.phone, ageGroup: found.ageGroup || f.ageGroup, emergencyContact: found.emergencyContact || f.emergencyContact, emergencyPhone: found.emergencyPhone || f.emergencyPhone }));
    }
  ...
  const labelStyle = { fontFamily: "'DM Sans',sans-serif", fontSize: 11, letterSpacing: 1, textTransform: "uppercase", color: "#A0907C", display: "block", marginBottom: 5 };

  const canSubmit = form.name && form.email && form.ageGroup;

  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 300, background: "rgba(61,50,37,0.45)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }} onClick={onClose}>
      <div onClick={e => e.stopPropagation()} style={{ background: "#FAF7F0", borderRadius: 22, maxWidth: 520, width: "100%", maxHeight: "90vh", overflow: "auto", position: "relative" }}>
        <button onClick={onClose} style={{ position: "absolute", top: 14, right: 14, width: 30, height: 30, borderRadius: "50%", background: "rgba(196,149,106,0.08)", border: "none", cursor: "pointer", fontSize: 16, color: "#7A6B5A", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 2 }}>×</button>
        ...
        <div style={{ padding: "28px 28px 0", borderBottom: "1px solid rgba(196,149,106,0.08)", paddingBottom: 20 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
            ...
            <div>
              <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 18, fontWeight: 600, color: "#3D3225" }}>{program.title}</div>
              <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "#A0907C" }}>{center.name}</div>
            </div>
          </div>
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "#7A6B5A" }}>
            <span>📅 {program.schedule}</span>
            <span style={{ padding: "2px 8px", borderRadius: 8, background: "rgba(196,149,106,0.06)", color: "#8B6F4E", fontWeight: 600, fontSize: 10, textTransform: "uppercase" }}>{program.audience}</span>
          </div>
          {program.fee > 0 && (
            <div style={{ marginTop: 10, padding: "8px 14px", borderRadius: 10, background: "rgba(196,149,106,0.06)", display: "inline-block" }}>
              <span style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 22, fontWeight: 600, color: "#3D3225" }}>${program.fee}</span>
              <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: "#A0907C", marginLeft: 4 }}>{program.currency}</span>
            </div>
          )}
          {program.fee === 0 && (
            <div style={{ marginTop: 10, padding: "8px 14px", borderRadius: 10, background: "rgba(139,154,111,0.1)", display: "inline-block" }}>
              <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, fontWeight: 600, color: "#8B9A6F" }}>FREE</span>
            </div>
          )}
          <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: spotsLeft < 5 ? "#D4766A" : "#A0907C", marginLeft: 12 }}>
        ...
        <div style={{ padding: 28 }}>
          {step === 1 && (
            <>
              {/* Email first — check for existing member */}
              <div style={{ marginBottom: 14 }}>
                <label style={labelStyle}>Email Address <span style={{ color: "#D4766A" }}>*</span></label>
                <div style={{ display: "flex", gap: 8 }}>
                  <input type="email" value={form.email} onChange={e => { setForm({ ...form, email: e.target.value }); setEmailChecked(false); setExistingMember(null); }}
                    style={{ ...inputStyle, flex: 1 }} placeholder="your@email.com"
                    onFocus={e => e.target.style.borderColor = "rgba(196,149,106,0.4)"} onBlur={e => { e.target.style.borderColor = "rgba(196,149,106,0.12)"; if (form.email && !emailChecked) checkEmail(); }} />
                </div>
                {existingMember && (
                  <div style={{ marginTop: 6, padding: "8px 12px", borderRadius: 8, background: "rgba(139,154,111,0.1)", fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "#8B9A6F" }}>
                    ✓ Welcome back, {existingMember.name}! Your details have been pre-filled.
                  </div>
                )}
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
                <div>
                  <label style={labelStyle}>Full Name <span style={{ color: "#D4766A" }}>*</span></label>
                  <input type="text" value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} style={inputStyle}
                    onFocus={e => e.target.style.borderColor = "rgba(196,149,106,0.4)"} onBlur={e => e.target.style.borderColor = "rgba(196,149,106,0.12)"} />
                </div>
                <div>
              ...
              <div style={{ marginBottom: 14 }}>
                <label style={labelStyle}>Age Group <span style={{ color: "#D4766A" }}>*</span></label>
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  {["Kid (6–12)", "Teen (13–17)", "Adult (18–59)", "Senior (60+)"].map(ag => (
                    <button key={ag} onClick={() => setForm({ ...form, ageGroup: ag })} style={{
                      padding: "8px 16px", borderRadius: 10, cursor: "pointer",
                      background: form.ageGroup === ag ? "#C4956A" : "#F3EDE2",
                      color: form.ageGroup === ag ? "#FAF7F0" : "#7A6B5A",
                      border: `1px solid ${form.ageGroup === ag ? "#C4956A" : "rgba(196,149,106,0.12)"}`,
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
                <div>
                  ...
                  <input type="text" value={form.emergencyContact} onChange={e => setForm({ ...form, emergencyContact: e.target.value })} style={inputStyle} placeholder="Name"
                    onFocus={e => e.target.style.borderColor = "rgba(196,149,106,0.4)"} onBlur={e => e.target.style.borderColor = "rgba(196,149,106,0.12)"} />
                </div>
                <div>
                  <label style={labelStyle}>Emergency Phone</label>
                  <input type="tel" value={form.emergencyPhone} onChange={e => setForm({ ...form, emergencyPhone: e.target.value })} style={inputStyle} placeholder="Phone"
                    onFocus={e => e.target.style.borderColor = "rgba(196,149,106,0.4)"} onBlur={e => e.target.style.borderColor = "rgba(196,149,106,0.12)"} />
                </div>
              </div>

              <textarea placeholder="Dietary needs, medical conditions, or questions..." value={form.notes} onChange={e => setForm({ ...form, notes: e.target.value })} rows={2}
                style={{ ...inputStyle, resize: "none", marginBottom: 20 }} />

              <button onClick={() => { if (canSubmit) { onRegister(program, form, existingMember); setStep(2); } }} style={{
                width: "100%", background: canSubmit ? "linear-gradient(135deg, #C4956A, #A07850)" : "#D4C5B0",
                border: "none", borderRadius: 11, padding: 15, cursor: canSubmit ? "pointer" : "not-allowed",
                fontFamily: "'DM Sans',sans-serif", fontSize: 13, letterSpacing: 2, textTransform: "uppercase", color: "#FAF7F0", fontWeight: 600,
              }}>Register{program.fee > 0 ? ` · $${program.fee} ${program.currency}` : ""}</button>
            </>
          )}
          ...
          {step === 2 && (
            <div style={{ textAlign: "center", padding: "12px 0" }}>
              ...
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: "#A0907C", marginBottom: 16 }}>
                Confirmation sent to <strong>{form.email}</strong>.
              </p>

              {program.fee > 0 && program.paymentInstructions && (
                <div style={{ textAlign: "left", padding: "16px 20px", borderRadius: 14, background: "rgba(196,149,106,0.06)", border: "1px solid rgba(196,149,106,0.1)", marginBottom: 16 }}>
                  <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, letterSpacing: 1.5, textTransform: "uppercase", color: "#C4956A", fontWeight: 600, marginBottom: 8 }}>💳 Payment Instructions</div>
                  <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: "#3D3225", lineHeight: 1.7 }}>{program.paymentInstructions}</p>
                  <div style={{ marginTop: 10, padding: "8px 12px", borderRadius: 8, background: "rgba(196,149,106,0.04)", fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "#7A6B5A" }}>
                    Amount due: <strong>${program.fee} {program.currency}</strong>
                  </div>
                </div>
              )}

              {program.fee === 0 && (
                <div style={{ padding: "10px 16px", borderRadius: 10, background: "rgba(139,154,111,0.1)", fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: "#8B9A6F", marginBottom: 16 }}>
                  This program is free. No payment required!
                </div>
              )}

              {program.whatToBring && (
                <div style={{ textAlign: "left", padding: "12px 16px", borderRadius: 10, background: "rgba(111,139,154,0.06)", marginBottom: 16 }}>
                  <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, letterSpacing: 1, textTransform: "uppercase", color: "#6F8B9A", fontWeight: 600, marginBottom: 4 }}>🎒 What to Bring</div>
                  <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "#7A6B5A", lineHeight: 1.6 }}>{program.whatToBring}</p>
                </div>
              )}
...
// ─── SESSION REGISTRATION MODAL (existing sessions) ───
...
function Hero({ scrollTo }) {
  ...
  return (
    <section id="home" style={{
      ...
      <div style={{ position: "absolute", width: 500, height: 500, borderRadius: "50%", border: "1.5px solid rgba(196,149,106,0.12)", top: -120, right: -120, animation: "float 20s ease-in-out infinite" }} />
      <div style={{ position: "absolute", width: 260, height: 260, borderRadius: "50%", border: "1.5px solid rgba(196,149,106,0.10)", bottom: -60, left: -60, animation: "float 16s ease-in-out infinite reverse" }} />
      <svg style={{ position: "absolute", top: "10%", right: "10%", opacity: 0.08, width: 170 }} viewBox="0 0 100 100">
    ...
    <section id="wisdom" style={{ padding: "100px 24px", background: "#FAF7F0", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
        <FadeIn><div style={{ textAlign: "center", marginBottom: 20 }}>
          <Tag>Wisdom Library</Tag>
          <Title>Deepen your <I>understanding</I></Title>
          ...
          {BOOKS.map((b, i) => (
            <FadeIn key={b.id} delay={i * 0.05}><div style={{ background: "#F7F2EA", borderRadius: 18, padding: 28, display: "flex", flexDirection: "column", height: "100%", border: "1px solid rgba(196,149,106,0.08)", transition: "all 0.35s" }}
              ...
              <div style={{ display: "flex", gap: 16, marginBottom: 16 }}>
                ...
                <div style={{ flex: 1 }}>
                  <h3 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 18, fontWeight: 600, color: "#3D3225", marginBottom: 4, lineHeight: 1.3 }}>{b.title}</h3>
                  <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: "#A0907C", fontStyle: "italic" }}>by Vethathiri Maharishi</div>
                </div>
              </div>
                ...
                <div style={{ background: "#F7F2EA", borderRadius: 18, overflow: "hidden", border: "1px solid rgba(196,149,106,0.08)", transition: "all 0.35s" }}
                  ...
                  <div style={{ width: "100%", paddingBottom: "56.25%", position: "relative", background: `linear-gradient(135deg,${cClr[v.cat] || "#C4956A"}15,${cClr[v.cat] || "#C4956A"}05)` }}>
                    <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 8 }}>
                      ...
                      <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 10, color: "#A0907C", letterSpacing: 1, textTransform: "uppercase" }}>SKY Yoga TV</span>
                    </div>
                    <span style={{ position: "absolute", top: 12, left: 12, fontSize: 9, padding: "4px 10px", borderRadius: 8, background: "rgba(255,255,255,0.85)", color: cClr[v.cat], fontFamily: "'DM Sans',sans-serif", fontWeight: 600, textTransform: "uppercase" }}>{icons[v.cat]} {v.cat}</span>
                  </div>
                  <div style={{ padding: "18px 22px" }}>
                    <h3 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 18, fontWeight: 600, color: "#3D3225", marginBottom: 4 }}>{v.title}</h3>
                    <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "#7A6B5A", lineHeight: 1.6 }}>{v.desc}</p>
                  </div>
                </div>
              </a></FadeIn>
            ))}
...
// ─── UPCOMING PROGRAMS SECTION (landing page) ───
function UpcomingPrograms({ programs, onViewProgram }) {
  const audienceColors = { adults: "#C4956A", kids: "#8B9A6F", teens: "#6F8B9A", family: "#9A7FB5" };
  return (
    <section id="programs" style={{ padding: "100px 24px", background: "#FAF7F0" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <FadeIn><div style={{ textAlign: "center", marginBottom: 48 }}>
          <Tag>Upcoming Programs</Tag>
          <Title>Enroll in a <I>course</I></Title>
          <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 15, color: "#7A6B5A", marginTop: 10, maxWidth: 520, margin: "10px auto 0" }}>
            Multi-day intensives, kids camps, workshops, and more across all our centers.
          </p>
        </div></FadeIn>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 20 }}>
          {programs.map((pg, i) => {
            const center = CENTERS.find(c => c.id === pg.centerId);
            const practice = PRACTICES.find(p => p.id === pg.practiceType);
            const loc = LOCATIONS.find(l => l.id === center.locationId);
            const spotsLeft = pg.capacity - pg.registered;
            return (
              <FadeIn key={pg.id} delay={i * 0.05}>
                <div onClick={() => onViewProgram(pg)} style={{
                  background: "#F7F2EA", borderRadius: 18, padding: 28, cursor: "pointer",
                  border: "1px solid rgba(196,149,106,0.08)", transition: "all 0.35s",
                  display: "flex", flexDirection: "column", height: "100%",
                }}
                ...
                >
                  <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 14 }}>
                    <span style={{ fontSize: 9, padding: "3px 10px", borderRadius: 10, background: `${practice.color}10`, color: practice.color, fontFamily: "'DM Sans',sans-serif", fontWeight: 600, textTransform: "uppercase" }}>{practice.icon} {practice.title}</span>
                    <span style={{ fontSize: 9, padding: "3px 10px", borderRadius: 10, background: `${audienceColors[pg.audience] || "#C4956A"}10`, color: audienceColors[pg.audience] || "#C4956A", fontFamily: "'DM Sans',sans-serif", fontWeight: 600, textTransform: "uppercase" }}>{pg.audience}</span>
                    <span style={{ fontSize: 9, padding: "3px 10px", borderRadius: 10, background: "rgba(196,149,106,0.06)", color: "#8B6F4E", fontFamily: "'DM Sans',sans-serif" }}>{pg.format}</span>
                  </div>
                  <h3 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 20, fontWeight: 600, color: "#3D3225", marginBottom: 8 }}>{pg.title}</h3>
                  <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "#A0907C", marginBottom: 4 }}>📍 {center.name} · {loc.id === "online" ? "Virtual" : `${loc.name}, ${loc.state}`}</div>
                  <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "#7A6B5A", marginBottom: 10 }}>📅 {pg.schedule}</div>
                  <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "#7A6B5A", lineHeight: 1.6, flex: 1, marginBottom: 16 }}>{pg.description.substring(0, 120)}...</div>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div>
                      {pg.fee > 0 ? (
                        <span style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 22, fontWeight: 600, color: "#3D3225" }}>${pg.fee} <span style={{ fontSize: 12, fontWeight: 400, color: "#A0907C" }}>{pg.currency}</span></span>
                      ) : (
                        <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, fontWeight: 600, color: "#8B9A6F" }}>FREE</span>
                      )}
                    </div>
                    <div style={{ textAlign: "right" }}>
                      <CapacityBar taken={pg.registered} total={pg.capacity} color={practice.color} />
                    </div>
                  </div>
                </div>
              </FadeIn>
...
function ProgramDetail({ program, onClose, onRegister, members, onRegisterSubmit }) {
  const center = CENTERS.find(c => c.id === program.centerId);
  const practice = PRACTICES.find(p => p.id === program.practiceType);
  const loc = LOCATIONS.find(l => l.id === center.locationId);
  const spotsLeft = program.capacity - program.registered;
  ...
  return (
    <>
      ...
      <button onClick={onClose} style={{
        background: "none", border: "none", cursor: "pointer", marginBottom: 28,
        fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: "#8B6F4E", display: "flex", alignItems: "center", gap: 6,
      }}><span>←</span> All Programs</button>

      {/* Header */}
      <div style={{
        background: `linear-gradient(135deg, ${practice.color}18, ${practice.color}08)`, borderRadius: 20, padding: "36px 36px 28px",
        marginBottom: 36, border: `1px solid ${practice.color}15`,
      }}>
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 14 }}>
          <span style={{ fontSize: 10, padding: "4px 12px", borderRadius: 12, background: `${practice.color}15`, color: practice.color, fontFamily: "'DM Sans',sans-serif", fontWeight: 600, textTransform: "uppercase" }}>{practice.icon} {practice.title}</span>
          <span style={{ fontSize: 10, padding: "4px 12px", borderRadius: 12, background: "rgba(196,149,106,0.08)", color: "#8B6F4E", fontFamily: "'DM Sans',sans-serif", fontWeight: 600, textTransform: "uppercase" }}>{program.audience}</span>
          <span style={{ fontSize: 10, padding: "4px 12px", borderRadius: 12, background: "rgba(196,149,106,0.06)", color: "#7A6B5A", fontFamily: "'DM Sans',sans-serif" }}>{program.format}</span>
        </div>
        <h1 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(26px, 4vw, 36px)", fontWeight: 400, color: "#3D3225", marginBottom: 10 }}>{program.title}</h1>
        <div style={{ display: "flex", gap: 20, flexWrap: "wrap", fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: "#7A6B5A" }}>
          <span>📍 {center.name}{loc.id !== "online" && ` · ${center.address}`}</span>
          <span>👤 {program.instructor}</span>
        </div>
        <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 14, color: "#3D3225", fontWeight: 500, marginTop: 10 }}>📅 {program.schedule}</div>
      </div>

      <div style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: 32, alignItems: "start" }} className="program-grid">
        {/* Left — details */}
        <div>
          <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 15, lineHeight: 1.8, color: "#7A6B5A", marginBottom: 24 }}>{program.description}</p>

          {program.whatToBring && (
            <div style={{ padding: "16px 20px", borderRadius: 14, background: "rgba(111,139,154,0.06)", marginBottom: 20 }}>
              <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, letterSpacing: 1.5, textTransform: "uppercase", color: "#6F8B9A", fontWeight: 600, marginBottom: 6 }}>🎒 What to Bring</div>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: "#7A6B5A", lineHeight: 1.7 }}>{program.whatToBring}</p>
            </div>
          )}

          {center.phone && (
            <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: "#A0907C" }}>
              Questions? Call {center.phone} or email the center.
            </div>
          )}
        </div>
        ...
        {/* Right — sign up card */}
        <div style={{
          background: "#F7F2EA", borderRadius: 18, padding: 28,
          border: "1px solid rgba(196,149,106,0.1)", position: "sticky", top: 80,
        }}>
          <div style={{ textAlign: "center", marginBottom: 16 }}>
            {program.fee > 0 ? (
              <div><span style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 36, fontWeight: 600, color: "#3D3225" }}>${program.fee}</span><span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: "#A0907C", marginLeft: 4 }}>{program.currency}</span></div>
            ) : (
              <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 18, fontWeight: 600, color: "#8B9A6F" }}>FREE</div>
            )}
          </div>
          <CapacityBar taken={program.registered} total={program.capacity} color={practice.color} />
          <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "#A0907C", textAlign: "center", marginTop: 6, marginBottom: 20 }}>
            {spotsLeft} spot{spotsLeft !== 1 ? "s" : ""} remaining
          </div>
          <button onClick={() => onRegister(program)} style={{
            width: "100%", background: spotsLeft > 0 ? "linear-gradient(135deg, #C4956A, #A07850)" : "#D4C5B0",
            border: "none", borderRadius: 11, padding: 15, cursor: spotsLeft > 0 ? "pointer" : "not-allowed",
            fontFamily: "'DM Sans',sans-serif", fontSize: 13, letterSpacing: 2, textTransform: "uppercase", color: "#FAF7F0", fontWeight: 600,
          }}>{spotsLeft > 0 ? "Register Now" : "Waitlist"}</button>

          {program.fee > 0 && program.paymentInstructions && (
            <div style={{ marginTop: 16, padding: "12px 14px", borderRadius: 10, background: "rgba(196,149,106,0.04)", border: "1px solid rgba(196,149,106,0.06)" }}>
              <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 10, letterSpacing: 1, textTransform: "uppercase", color: "#C4956A", fontWeight: 600, marginBottom: 4 }}>Payment Info</div>
              <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: "#7A6B5A", lineHeight: 1.6 }}>{program.paymentInstructions}</p>
            </div>
          )}
        </div>
      </div>
    ...
    <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, background: scrolled ? "rgba(250,247,240,0.97)" : "transparent", backdropFilter: scrolled ? "blur(12px)" : "none", borderBottom: scrolled ? "1px solid rgba(180,160,130,0.1)" : "none", transition: "all 0.4s", padding: scrolled ? "10px 0" : "16px 0" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", gap: 24, alignItems: "center" }} className="desktop-nav">
          ...
          <button onClick={onExploreCourses} style={{ background: "none", border: "none", cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontSize: 12, letterSpacing: 1.5, textTransform: "uppercase", color: active === "programs" ? "#C4956A" : "#5C4E3C", borderBottom: active === "programs" ? "2px solid #C4956A" : "2px solid transparent", paddingBottom: 3, transition: "all 0.3s" }}>Programs</button>
          ...
          <button onClick={() => scrollTo("wisdom")} style={{ background: "none", border: "none", cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontSize: 12, letterSpacing: 1.5, textTransform: "uppercase", color: active === "wisdom" ? "#C4956A" : "#5C4E3C", borderBottom: active === "wisdom" ? "2px solid #C4956A" : "2px solid transparent", paddingBottom: 3, transition: "all 0.3s" }}>Library</button>
      ...
      {open && (
        <div style={{ position: "absolute", top: "100%", left: 0, right: 0, background: "rgba(250,247,240,0.98)", backdropFilter: "blur(16px)", padding: 20, borderBottom: "1px solid rgba(180,160,130,0.12)" }}>
          {[{ l: "Home", a: () => scrollTo("home") }, { l: "About", a: () => scrollTo("about") }, { l: "Practices", a: () => scrollTo("services") }, { l: "Programs", a: onExploreCourses }, { l: "Centers", a: onFindCenter }, { l: "Library", a: () => scrollTo("wisdom") }, { l: "Stories", a: () => scrollTo("testimonials") }, { l: "Contact", a: () => scrollTo("contact") }].map((item, i) => (
...
export default function SKYYogaDallas() {
  ...
  const [overlay, setOverlay] = useState(null); // "courses" | "centers" | "programs" | null
  ...
  const [regProgram, setRegProgram] = useState(null);
  const [viewProgram, setViewProgram] = useState(null);
  const [programs, setPrograms] = useState(PROGRAMS_INIT);
  const [members, setMembers] = useState([
    // seed a returning member for demo
    { id: "m1", name: "Vijaya Lakshmi", email: "vijaya@example.com", phone: "+1 (972) 555-9999", ageGroup: "Adult (18–59)", emergencyContact: "Ravi S.", emergencyPhone: "+1 (972) 555-8888" },
  ]);
  const [registrations, setRegistrations] = useState([]);

  const handleProgramRegister = (program, form, existingMember) => {
    // Create or reuse member
    let memberId;
    if (existingMember) {
      memberId = existingMember.id;
    } else {
      memberId = "m" + (members.length + 1);
      setMembers(prev => [...prev, { id: memberId, name: form.name, email: form.email, phone: form.phone, ageGroup: form.ageGroup, emergencyContact: form.emergencyContact, emergencyPhone: form.emergencyPhone }]);
    }
    // Create registration
    setRegistrations(prev => [...prev, { id: "r" + (prev.length + 1), memberId, programId: program.id, status: "registered", notes: form.notes, registeredAt: new Date().toISOString() }]);
    // Update program spots
    setPrograms(prev => prev.map(p => p.id === program.id ? { ...p, registered: p.registered + 1 } : p));
  };

  useEffect(() => {
    const h = () => { for (const s of ["home", "about", "services", "programs", "locations", "testimonials", "wisdom", "contact"]) { const el = document.getElementById(s); if (el) { const r = el.getBoundingClientRect(); if (r.top <= 120 && r.bottom > 120) { setActiveSection(s); break; } } } };
  ...
  const openPrograms = (program) => { setViewProgram(program || null); setOverlay("programs"); };
    ...
    <div>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}html{scroll-behavior:smooth}body{background:#FAF7F0}
        ...
        @media(max-width:768px){.desktop-nav{display:none!important}.mobile-toggle{display:block!important}.about-grid{grid-template-columns:1fr!important;gap:32px!important}.path-grid{grid-template-columns:1fr!important}.program-grid{grid-template-columns:1fr!important}}
      ...
      <UpcomingPrograms programs={programs} onViewProgram={openPrograms} />
      ...
      {/* OVERLAY: Program Detail */}
      <Overlay open={overlay === "programs"} onClose={() => { setOverlay(null); setViewProgram(null); }}>
        {viewProgram ? (
          <ProgramDetail
            program={viewProgram}
            onClose={() => { setOverlay(null); setViewProgram(null); }}
            onRegister={setRegProgram}
            members={members}
          />
        ) : (
          /* All programs browse view */
          <>
            <div style={{ textAlign: "center", marginBottom: 48 }}>
              <Tag>All Programs</Tag>
              <Title>Find your <I>course</I></Title>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 20 }}>
              {programs.map(pg => {
                const center = CENTERS.find(c => c.id === pg.centerId);
                ...
                const loc = LOCATIONS.find(l => l.id === center.locationId);
                return (
                  <div key={pg.id} onClick={() => setViewProgram(pg)} style={{
                    background: "#F7F2EA", borderRadius: 18, padding: 28, cursor: "pointer",
                    border: "1px solid rgba(196,149,106,0.08)", transition: "all 0.35s",
                  }}
                    onMouseOver={e => { e.currentTarget.style.transform = "translateY(-3px)"; e.currentTarget.style.boxShadow = "0 12px 40px rgba(61,50,37,0.06)"; }}
                  ...
                  >
                    <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 12 }}>
                      <span style={{ fontSize: 9, padding: "3px 10px", borderRadius: 10, background: `${practice.color}10`, color: practice.color, fontFamily: "'DM Sans',sans-serif", fontWeight: 600, textTransform: "uppercase" }}>{practice.icon} {practice.title}</span>
                      <span style={{ fontSize: 9, padding: "3px 10px", borderRadius: 10, background: "rgba(196,149,106,0.06)", color: "#8B6F4E", fontFamily: "'DM Sans',sans-serif" }}>{pg.audience} · {pg.format}</span>
                    </div>
                    <h3 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 19, fontWeight: 600, color: "#3D3225", marginBottom: 6 }}>{pg.title}</h3>
                    <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "#A0907C", marginBottom: 4 }}>📍 {center.name} · {loc.id === "online" ? "Virtual" : loc.name}</div>
                    <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "#7A6B5A", marginBottom: 12 }}>📅 {pg.schedule}</div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      {pg.fee > 0 ? <span style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 20, fontWeight: 600, color: "#3D3225" }}>${pg.fee}</span> : <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, fontWeight: 600, color: "#8B9A6F" }}>FREE</span>}
                      <CapacityBar taken={pg.registered} total={pg.capacity} color={practice.color} />
                    </div>
                  </div>
                );
      ...
      {regProgram && <ProgramRegModal program={regProgram} onClose={() => setRegProgram(null)} members={members} onRegister={handleProgramRegister} />}
    </div>
  );
}
